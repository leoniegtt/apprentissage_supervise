...
rf_model = RandomForestClassifier(
    ...
    n_estimators=200,
    random_state=0  # You can set a random_state for reproducibility
)

X_train = scaler.fit_transform(X_train)
rf_model.fit(X_train, y_train["PINCP"])
...
result = permutation_importance(rf_model, X_test, y_test["PINCP"], n_repeats=20, random_state=0)
